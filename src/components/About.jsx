    ...
    <div id='about' className='bg-white px-4 py-16'>
      <div className='justify-center md:mx-40'>
        ...
        <p>
          ...
          Zurich, Switzerland. I am 15 years old and I am a student at the{" "}
        ...
        <p className='mt-2'>
          I love creating content and sharing it. For this, I use products like
          Premiere Pro, After Effects, Illustrator and more from the Adobe
          Creative Cloud.
        </p>
        <p>
          My other interests are tech in general, productivity,
          self-improvement, rowing and I play the piano.
        </p>
      </div>
    </div>
  );

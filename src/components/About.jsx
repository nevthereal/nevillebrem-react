  ...
  return (
    <div id='about' className='bg-white px-4 py-16'>
        <div className='grid md:grid-cols-2 justify-center'>
            <h1 className='mx-auto p-16 md:my-auto uppercase font-bold text-center font-[Montserrat]'><i className='fa-solid fa-circle-info text-3xl md:text-4xl'></i> About me</h1>
            <p className='my-auto'>
                ...
                I <span className='important'>love creating</span> stuff and <span className='important'>editing</span> videos or photos. I am familiar with the <span className='important'>Adobe Creative Cloud</span> (more later). 
            </p>
        </div>
    </div>
  )

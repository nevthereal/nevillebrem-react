...
const Hero = () => {
  ...
  useEffect(() => {
    const typed = new Typed(professions.current, {
      strings: ["Web Developer", "Video Editor", "Motion Designer", "Content Creator"],
      typeSpeed: 80,
      backSpeed: 60,
      loop: true
    });
  ...
  return (
    <div className='h-screen px-4 text-white wave-white'>
        <div className='mt-[-6rem] w-full h-screen mx-auto text-center flex flex-col justify-center'>
            ...
            <p className='text-gray-400 font-bold text-lg md:text-xl'>I am a <span ref={professions}></span> </p>

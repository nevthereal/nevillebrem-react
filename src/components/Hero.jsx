  ...
  return (
    <div className='h-screen px-4 text-white wave-white'>
        <div className='mt-[-6rem] w-full h-screen mx-auto text-center flex flex-col justify-center'>
            <p className='md:text-lg mx-auto font-bold font-mono uppercase text-nevBlue'><span className='text-yellow-500'>print</span><span className='text-pink-500'>(</span>'Hello World my name is'<span className='text-pink-500'>)</span></p>
